...
\begin{abstract}
  ...
  Recent studies have proposed near data processing (NDP) and 
  processing-in-memory (PIM)  solutions for step 2, 
  ...
  Thus,
  this paper propose novel reformulations of soft searching and attention pooling operator with linear complexity,
  and further propose new NDP/PIM architecture and communication protocol 
...
%These servers are connected by low bandwidth 100Gbps network,
%10x slower than 600GBps NVswitch network.
