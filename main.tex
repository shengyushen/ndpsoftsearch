...
it is a very time consuming task accounting for more than 80\% of inference
...
to load these long sequences across the low bandwidth network connecting
...
not the more complex ones such as soft searching in SIM \cite{recsys_sim_alibaba}
